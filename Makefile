...
# Generated by qmake (2.01a) (Qt 4.5.2) on: so 4 10 12:13:50 2010
...
compiler_moc_header_make_all: build/moc_Clicker.cpp build/moc_Communicator.cpp build/moc_Controller.cpp build/moc_Evaluator.cpp build/moc_GameWindow.cpp build/moc_InitDialog.cpp build/moc_Initializer.cpp build/moc_Model.cpp build/moc_NetReceiver.cpp build/moc_NetSender.cpp build/moc_PacketQueue.cpp build/moc_QueueReceiver.cpp build/moc_QueueSender.cpp build/moc_Receiver.cpp build/moc_Sender.cpp build/moc_SettingsController.cpp build/moc_SettingsDialog.cpp build/moc_SettingsModel.cpp build/moc_View.cpp
...
build/moc_NetSender.cpp: Sender.h \
		Packet.h \
		NetSender.h
