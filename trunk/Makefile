...
# Generated by qmake (2.01a) (Qt 4.5.2) on: st 4 7 19:15:02 2010
...
SOURCES       = Base.cpp \
		...
		Stone.cpp \
		Tank.cpp \
		View.cpp build/moc_Communicator.cpp \
...
compiler_moc_header_make_all: build/moc_Communicator.cpp build/moc_GameWindow.cpp build/moc_InitDialog.cpp build/moc_Initializer.cpp build/moc_Model.cpp build/moc_SettingsController.cpp build/moc_SettingsDialog.cpp build/moc_SettingsModel.cpp build/moc_View.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_Communicator.cpp build/moc_GameWindow.cpp build/moc_InitDialog.cpp build/moc_Initializer.cpp build/moc_Model.cpp build/moc_SettingsController.cpp build/moc_SettingsDialog.cpp build/moc_SettingsModel.cpp build/moc_View.cpp
...
build/moc_SettingsModel.cpp: Player.h \
		SettingsModel.h
...
build/Dispatcher.o: Dispatcher.cpp Dispatcher.h \
		Sender.h \
		Packet.h \
		PacketQueue.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Dispatcher.o Dispatcher.cpp
