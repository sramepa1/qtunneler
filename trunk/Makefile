...
# Generated by qmake (2.01a) (Qt 4.5.2) on: pá 4 9 16:58:41 2010
...
compiler_moc_header_make_all: build/moc_Communicator.cpp build/moc_Controller.cpp build/moc_Evaluator.cpp build/moc_GameWindow.cpp build/moc_InitDialog.cpp build/moc_Initializer.cpp build/moc_Model.cpp build/moc_SettingsController.cpp build/moc_SettingsDialog.cpp build/moc_SettingsModel.cpp build/moc_View.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_Communicator.cpp build/moc_Controller.cpp build/moc_Evaluator.cpp build/moc_GameWindow.cpp build/moc_InitDialog.cpp build/moc_Initializer.cpp build/moc_Model.cpp build/moc_SettingsController.cpp build/moc_SettingsDialog.cpp build/moc_SettingsModel.cpp build/moc_View.cpp
